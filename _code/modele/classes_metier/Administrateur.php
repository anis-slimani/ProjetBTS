...
CREATE TABLE Administrateurs(
	...
	mailAdministrateur varchar(30) unique,   
...
class Administrateur
{
   ...
   private ?string $mailAdministrateur; 
   ...
   public function __construct()
   {
      ...
      // premier cas : new Administrateur($loginAdministrateur, $passwordAdministrateur) 
      else if (func_num_args() == 2) { // on a les 2 arguments dans un tableau
         $this->idAdministrateur = 0;     // pas d'id : on met 0 en dur
         $this->loginAdministrateur = func_get_arg(0);       // argument 1 : $loginAdministrateur
         $this->passwordAdministrateur = func_get_arg(1); // argument 2 : $passwordAdministrateur
      }
   }
   ...
   {
      return $this->passwordAdministrateur;
   }
   ...
   // méthode qui sette les paramètres du Administrateur
   public function setAdministrateur(
      int $idAdministrateur,
      string $loginAdministrateur,
      string $passwordAdministrateur
   ): void {
   ...
   {
      echo "id : " . $this->idAdministrateur . "<br>";
      echo "Login : " . $this->loginAdministrateur . "<br>";
      echo "Password : " . $this->passwordAdministrateur . "<br>";
   }
   ...
   {
      if (
         isset($this->idAdministrateur) and 
         isset($this->loginAdministrateur) and 
         isset($this->passwordAdministrateur)
      ) {
         return
            'id = ' . $this->idAdministrateur .
            ' - Login = ' . $this->loginAdministrateur .
            ' - Password = ' . $this->passwordAdministrateur;
      } else {
         return 'objet vide';
      }
   }
